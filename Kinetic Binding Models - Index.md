...
| --------- | ------------------------------------------------------- | -------------- |
| $k_{a,2}$ | association rate constant between analyte and ligand 2  | $M^{-1}s^{-1}$ |
| $k_{d,2}$ | dissociation rate constant between analyte and ligand 2 | $s^{-1}$       |
...
| $k_{a,2}$ | rate parameter for adopting first conformation  | $s^{-1}$ |
...
#### Variables, Parameters, and Units
| Table E   | Meaning                                       | Unit            |
| --------- | --------------------------------------------- | --------------- |
| $k_{a,2}$ | association rate parameter for second binding | $RU^{-1}s^{-1}$ |
See above for discussion.
#### Differential Equation
$$\begin{align}
\frac{dR_1}{dt} &= 2k_{a,1}C(R_{max} - R_1 - 2R_2) - k_{d}R_1 - k_{a,2}R_1(R_{max} - R_1 - 2R_2) + 2k_{d}R_2 \\
\frac{dR_2}{dt} &= 2k_{a,2}R_1(R_{max} - R_1 - 2R_2) - 2k_{d}R_2 \\
R&=R_1+R_2
\end{align}$$
